...
const Hero = () => {
  return (
    <section className='bg-black  w-full max-h-sm relative md:py-32 md:pb-64 sm:py-8 sm:pt-32 pt-24 py-8 duration-700'>
      <div className='flex flex-col md:flex-row md:justify-between md:mx-16 mx-4 lg:mx-24'>
        ...
        >
          ...
          <p className='opacity-50 text-sm font-thin max-w-[300px] text-center md:text-left'>
